<header>
	<div class="akun"><a href="<?php echo base_url(); ?>admin/dashboard/config" title="Update Konfigurasi"><img src="<?php echo base_url(); ?>assets/images/imaginearts.png" width="16" height="16">Peminjaman Sepeda</a></div>
